...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.1067
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.1067
...
require (
	...
	github.com/ClickHouse/clickhouse-go/v2 v2.1.1 // indirect
